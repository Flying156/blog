...
@Data
@Component
@ConfigurationProperties("blog.async-schedule")
public class AsyncScheduleProperty {
     ...
     * 异步调用线程名称前缀
     */
    private final String executorThreadNamePrefix = "taskExecutor-";

    /**
     * 定时任务线程名称前缀
     */
    private final String schedulerThreadNamePrefix = "taskExecutor-";
